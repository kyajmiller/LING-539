...
print("1 percent\t\t%s" % hmmAccuracy1)
print("2 percent\t\t%s" % hmmAccuracy2)
print("3 percent\t\t%s" % hmmAccuracy3)
print("4 percent\t\t%s" % hmmAccuracy4)
print("5 percent\t\t%s" % hmmAccuracy5)
print("10 percent\t\t%s" % hmmAccuracy10)
print("25 percent\t\t%s" % hmmAccuracy25)
print("50 percent\t\t%s" % hmmAccuracy50)
print("75 percent\t\t%s" % hmmAccuracy75)
print("90 percent\t\t%s" % hmmAccuracy90)
